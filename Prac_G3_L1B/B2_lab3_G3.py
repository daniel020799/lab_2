...
class B2_lab3_G3(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "B2_lab3_G3")
        ...
        # Variables
        ##################################################
        self.samp_rate = samp_rate = 10321920*10
        self.A = A = 1
        ...
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_SAW_WAVE, 49000, 1, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 10321920, A, 0, 0)
        ...
        self.connect((self.blocks_multiply_xx_0, 0), (self.CalculoPotenciaComunicaciones_0_0, 0))
...
def main(top_block_cls=B2_lab3_G3, options=None):
